program g3ej2
    implicit none
    integer ii
    integer, parameter :: n=10 , indep=1    !n:orden de la matriz, indep=orden de vector terminos independientes
    !real(8) Mi(n,n), bi(n), mat_ampl(n,n+indep) !para gauss,regresiva y crout
