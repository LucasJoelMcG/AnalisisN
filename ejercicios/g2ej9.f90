program g2ej3b
    ...
    INTEGER, PARAMETER :: cant_ecu=1, max_itera=1000
    REAL(8), DIMENSION(0:1) :: vii
    REAL(8) :: h1=0.5
    real(8) :: tolerancia=0.005
    vii(1)=40.0 !esto es y
    vii(0)=0.0 !este es x
    ...
    SUBROUTINE RungeKuttaFehlbergH(vi, cant_ec, max_iter, h, tol)
        ...
        DO iter = 1, max_iter
            ...
            WRITE (*, '(I5, 2F10.6, 2F22.19)') iter, v, maxval(abs(e)), h
            WRITE (2, '(I5, 2F10.6, 2F22.19)') iter, v, maxval(abs(e)), h
        END DO
        CLOSE(2,status='keep')
