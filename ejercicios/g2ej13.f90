program g2ej3b
    ...
    INTEGER, PARAMETER :: cant_ecu=4, max_itera=75
    ...
    FUNCTION v_prima(v)
        ...
        !v(0)=x v(1)=y
        REAL(8), DIMENSION(0:4) :: v, v_prima
        v_prima(0) = 1.0
        v_prima(1) = v(2)
        v_prima(2) = (-6.10*v(1)+8.8*(v(3)-v(1))-41.0*v(2))/174.0
        v_prima(3) = v(4)
        v_prima(4) = (-5.8*v(3)-8.8*(v(3)-v(1))-21*v(4))/132.0
